...
namespace EduTrail.Infrastructure.Migrations
{
    ...
    [Migration("20260226204312_TA-MonthTable-Add")]
    partial class TAMonthTableAdd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTrail.Domain.Entities.TALabDay", b =>
                {
                    ...
                    b.HasOne("EduTrail.Domain.Entities.TALabMonth", null)
                        .WithMany("Days")
            ...
            modelBuilder.Entity("EduTrail.Domain.Entities.TALabMonth", b =>
                {
                    b.HasOne("EduTrail.Domain.Entities.Enrollment", null)
                        .WithMany("TALabDays")
                        .HasForeignKey("EnrollmentId");
                });
